<x-layouts.layout titulo="Register">
    <div class="flex flex-row justify-center items-center min-h-full bg-gray-200">
        <!-- Session Status -->
        <div class="bg-white rounded-2xl p-8 shadow-lg w-full max-w-md">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    ...
                    <x-text-input 
                        id="name" 
                        class="block mt-1 w-full bg-gray-100 border-2 border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500" 
                        type="text" 
                        name="name" 
                        :value="old('name')" 
                        required 
                        autofocus 
                        autocomplete="name" 
                        placeholder="{{ __('Introduce tu nombre') }}"
                    />
